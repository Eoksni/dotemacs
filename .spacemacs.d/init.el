...
values."
  (setq-default
   ...
   '(
     (elfeed :variables rmh-elfeed-org-files (list (concat dmaz/syncthing-dir "notes/elfeed.org")))
     ipython-notebook
     ruby
     windows-scripts
     php
