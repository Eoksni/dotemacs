...
you should place your code here."
  ;; so that newly created frames get focus automatically
  (push #'dmaz/focus-frame after-make-frame-functions)
  ...
  (use-package elfeed-goodies
    ...
    (define-key elfeed-show-mode-map (kbd "SPC") #'dmaz/elfeed-scroll)
    )
